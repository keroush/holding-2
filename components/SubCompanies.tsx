    ...
    <section className="section-padding bg-gray-800 md:bg-gray-900 pt-20 md:pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden relative -mt-8 -mb-10 overflow-hidden">
                  ...
                  >
                    <div className="rounded-xl overflow-hidden shadow-lg border border-gray-700 h-full flex flex-col mx-2">
                      ...
                      <div className="relative h-48 overflow-hidden">
                        ...
                        {/* Bottom Tags */}
                        <div className="absolute bottom-[2.25rem] left-2 z-30">
                          <div className="flex flex-wrap gap-1">
                            {company.bottomTags.slice(0,3).map((tag, tagIndex) => (
                              <span key={tagIndex} className="bg-gray-200 text-black text-xs px-2 py-1 rounded-full shadow-xl font-bold border-[0.09rem] border-yellow-300">
                                {tag}
          ...
          <button
            onClick={prevSlide}
            className="absolute right-[3rem] bottom-[0.6rem] z-20 w-10 h-10 bg-black/60 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-black/80 transition-all duration-300 border border-white/20"
          >
          ...
          <button
            onClick={nextSlide}
            className="absolute right-[0.4rem] bottom-[0.6rem] z-20 w-10 h-10 bg-black/60 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-black/80 transition-all duration-300 border border-white/20"
          >
            <ChevronRight className="h-5 w-5 text-white" />
          </button>

          {/* Slide Indicators */}
          <div className="absolute bottom-[0.6rem] left-[0.6rem] justify-center mt-6 space-x-2 z-10">
